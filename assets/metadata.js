...
const SARDINE_METADATA = {
    ...
    socialNetworks: [
        ...
        {
            name: "Email",
            url: "mailto:contact@sardine-lab.org",
    ...
    updateFooter() {
        ...
        footer.innerHTML = `
            <div class="px-4 grid gap-8 md:grid-cols-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-slate-100 mb-3">Research Areas</h3>
                    <ul class="space-y-2 text-sm text-slate-400">
                        ${this.metadata.researchAreas.map(area => `<li>${area}</li>`).join('')}
                    </ul>
                </div>
                <div>
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { MetadataManager, SARDINE_METADATA };
}